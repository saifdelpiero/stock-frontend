...
export default function CreatePurchaseOrder() {
  ...
  return (
    <div>
      <PageMeta
        title="Stock Management System | Create Purchase Order"
        description="Stock Management System Create Purchase Order Page"
      />
      <PageBreadcrumb pageTitle="Create Purchase Order" />
